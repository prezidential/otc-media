  ...
  return (
    <div className="p-6 lg:p-10 max-w-[1100px]">
      ...
      <div className="rounded-xl border border-border bg-card p-5 mb-6">
        <button type="button" onClick={() => setShowManual(!showManual)} className="w-full flex items-center justify-between">
        ...
        {showManual && (
          <div className="mt-4 space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              {manualMessage && (
                <span
                  className={`text-sm font-mono ${manualMessage === "Signal added" ? "text-primary" : "text-danger"}`}
                >
                  {manualMessage}
                </span>
              )}
